...
class Login extends Component {
  ...
  handleSubmit = async event => {
    ...
    if (password.length < 6 || password.length > 32) {
      return toast.error('Mật khẩu phải từ 6 - 32 ký tự');
    }
    const user = {
      email,
      password
    ...
    return (
      <div className="page login-page">
              ...
              <div className="col-lg-6 bg-white">
                <div className="form d-flex align-items-center">
                  <div className="content">
                    ...
                    {/* <Link to="#" className="forgot-pass" style={{marginTop:15}}>Quên mật khẩu?</Link> */}
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="copyrights text-center">
          {/*  <p>Design by <a href="https://bootstrapious.com/p/admin-template" className="external">Developer</a> 
          </p>*/}
