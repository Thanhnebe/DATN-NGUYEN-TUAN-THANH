      ...
      <div className="content-inner">
        ...
        <header className="page-header">
          <div className="container-fluid">
            <h2 className="no-margin-bottom">Tài khoản</h2>
          </div>
        </header>
        {/* Breadcrumb*/}
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <form className="form-horizontal" onSubmit={(event) => this.handleSubmit(event)}>
                      ...
                      <div className="line" />
                      <div className="form-group row">
                        <label htmlFor="fileInput" className="col-sm-3 form-control-label">Ảnh đại diện</label>
                        <div className="col-sm-9">
                      ...
                      <div className="line" />
                      <div className="form-group row">
                        <label className="col-sm-3 form-control-label">Loại tài khoản</label>
                        <div className="col-sm-9">
                          <select className="form-control mb-3" name="roleId" value={roleId} onChange={this.handleChange}>
                            {dataRole && dataRole.length ?
                              dataRole.map((item, index) => {
                                ...
                                return (
                                  <option key={index} value={item.id} >{role[item.nameRole]}</option>
                                )
                              })
                              : null
                            }
                      ...
                      <div className="form-group row">
                        <div className="col-sm-4 offset-sm-3">
                          <button type="reset" className="btn btn-secondary" style={{ marginRight: 2 }}>Hủy bỏ</button>
