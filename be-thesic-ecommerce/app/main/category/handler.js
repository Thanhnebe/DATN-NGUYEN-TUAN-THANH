...
exports.getTree = {
  ...
  notes: 'Return Category tree',
  tags: ['api', 'v1'],
  handler: controller.getCategoryTree.bind(controller),
  auth: false,
  // validate: {
  //   query: validator.searchParams
  // }
...
exports.getCategoriesParent = {
  description: 'Get a Categories parent',
  notes: 'Return a Category by id',
  tags: ['api', 'v1'],
  handler: controller.getCategoriesParent.bind(controller),
  auth: {
    strategy: 'jwt',
    scope: ['admin', 'superadmin', 'staff']
  },
